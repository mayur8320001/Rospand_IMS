...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rospand_IMS.Models.Employee.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rospand_IMS.Models.Employee.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rospand_IMS.Models.Employee.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rospand_IMS.Models.Employee.Employee", b =>
                {
                    b.HasOne("Rospand_IMS.Models.Employee.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Rospand_IMS.Models.Employee.Position", "Position")
                        .WithMany()
